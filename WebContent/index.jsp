 ...
 <ul>
  <li>
   <dl>
    <dt>租车模块</dt>
    <!--当前链接则添加class:active-->
    <dd><a href="rentCarServlet?method=listAll" class="active">汽车列表示例</a></dd>
    <dd><a href="rentCarServlet?method=add">添加共享汽车</a></dd>   
   </dl>
  </li>
  <li>
   <dl>
    ...
    <dd><a href="order_detail.html">添加订单</a></dd>
   </dl>
  </li>
  <li>
   <dl>
    ...
    <dd><a href="user_detail.html">添加用户信息</a></dd>
  ...
  <li>
   <dl>
    <dt>新闻模块</dt>
    <dd><a href="discharge_statistic.html">新闻列表</a></dd>
    <dd><a href="sales_volume.html">添加新闻</a></dd>
   </dl>
  </li>
  <li>
   <p class="btm_infor">© XB357.cn 版权所有</p>
  </li>
 </ul>
</aside>
